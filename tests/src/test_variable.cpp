...
{
public:
	ghost::Variable var_ctor1 { std::vector<int>{1,3,5,7,9}, 3, "var_ctor1" };
	ghost::Variable var_ctor2 { std::vector<int>{1,3,5,7,9}, 2 };
	ghost::Variable var_ctor3 { std::vector<int>{1,3,5,7,9} };
